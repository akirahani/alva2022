...
$config['LicenseName'] = 'Alva';
$config['LicenseKey'] = '5A8NSGXLHEJGQE3QTVE1VP99PG57VVJV';
//$config['licenseName'] = 'daxuyensang.vn';
//$config['licenseKey']  = 'VG3GMNC6Y4R1JZDKLSTBZWNDJYFJ7';
...
*/
$baseUrl = '/uploads/';//website
//$baseUrl = '/alva/uploads/';//localhost
/*
