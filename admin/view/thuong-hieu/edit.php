<?php
	...
	if(isset($_POST['update']))
	{
        ...
        $query->CapNhat("thuonghieu", $fields, $condition, $post_form);
		header("location:thuong-hieu");
	}
?>
<div class="blog small">
	<div class="bread">
		<h1>Thương hiệu <span>| cập nhật</span></h1>
		<div class="button"><button><a href="them-thuong-hieu">Thêm mới</a></button></div>
		<div class="clear"></div>
	</div>
	...
	<form method="post" enctype="multipart/form-data" class="form">
		...
		<p class="tit-label"></p>
		<img src="../uploads/hang/<?php echo $data_detail->hinh;?>" height=50 />
